...
export class CellManagerSystem {
    constructor(cellBundler, center) {
        this.resolveCallback = (temp, resolve) => { this.cellBundler.CellGrid = temp; this.isLoading = false; resolve(); };
    ...
    loadCells() {
        ...
        this.loading = new Promise((resolve) => {
            ...
            if (this.center.x < lowerLimitX) {
                ...
                // 7 8 9
                // Shift right
                const temp = shiftGrid(tileBuffer, 0, 1, this.cellWidth);
                // Unused
                // v    
                // 3 1 2
                // 6 4 5
                ...
                // 7 8 9 <= Unused
                // Shift down
                const temp = shiftGrid(tileBuffer, 1, 0, this.cellWidth);
                // 7 8 9 <= Unused
                // 1 2 3
                // 4 5 6
                // Update new tiles

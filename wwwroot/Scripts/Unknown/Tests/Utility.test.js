...
import { AreaSwitch } from "../Command/Utility/AreaSwitch.js";
...
const testWrapper = (testCoordinate) => AreaSwitch(testCoordinate, testArea, topLeft, topCenter, topRight, centerLeft, centerCenter, centerRight, bottomLeft, bottomCenter, bottomRight);
// Existing Tests
test('Center', () => {

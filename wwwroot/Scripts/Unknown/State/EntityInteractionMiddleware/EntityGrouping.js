...
export class EntityGrouping {
    ...
    sortedEntities;
    constructor(effectiveArea, entities, worldScope, EventHandlingSystems, topLeftGrouping, topCenterGrouping, topRightGrouping, centerLeftGrouping, centerRightGrouping, bottomLeftGrouping, bottomCenterGrouping, bottomRightGrouping) {
        this.effectiveArea = effectiveArea;
        this.worldScope = worldScope;
        this.EventHandlingSystems = EventHandlingSystems;
...
export const GenerateNewGroupingWithEntity = (entity, oldSquareArea, worldScope, groupingRelativePosition, eventHandling) => {
    ...
    const newEventHandlingSystems = BuildSystemsForNewGrouping(eventHandling.Communicate.conversationComponents.filter((testValue) => testValue.locationReference === entity));
    const newGrouping = new EntityGrouping(area, [entity], worldScope, newEventHandlingSystems, x0y0, x1y0, x2y0, x0y1, x2y1, x0y2, x1y2, x2y2);
...
export const BuildSystemsForNewGrouping = (conversationComponents) => {

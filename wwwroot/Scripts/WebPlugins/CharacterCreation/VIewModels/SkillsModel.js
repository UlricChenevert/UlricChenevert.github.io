...
import { rollAbility } from "../Utility/DiceRoll.js";
...
export class SkillsModel {
    ...
    Init() {
        ...
        const abilityData = AbilitiesToArray(this.GlobalCharacterData.Abilities());
    ...
    Randomize() {
        const abilityData = AbilitiesToArray(this.CurrentlySelectedAbilities());

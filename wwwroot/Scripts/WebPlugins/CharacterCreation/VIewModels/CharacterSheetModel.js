...
export class CharacterSheetModel {
    ...
    constructor(GlobalCharacterData) {
        ...
        const namePickerModel = new CreateObjectModel("Name", new NamePickerModel(this.GlobalCharacterData, TaggedCharacterNameData, TaggedCharacterBynameData, TaggedCharacterEpithetsData), (data) => {
            return data.Name;
        }, NameUtility.determineFullNameFromCharacterName, () => true, GlobalCharacterData);

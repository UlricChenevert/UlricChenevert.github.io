...
export class CharacterWizardModel extends Wizard {
    ...
    constructor() {
        ...
        panels.push(Utility.BundleViewAndModel(new EntryConfigurationModel(this.characterData, this.next.bind(this), this.Randomize.bind(this))), Utility.BundleViewAndModel(new PropensityViewModel(this.characterData)), Utility.BundleViewAndModel(new BackgroundViewModel(this.characterData)), Utility.BundleViewAndModel(new SkillsModel(this.characterData)), Utility.BundleViewAndModel(new ReligionPickerModel(this.characterData, possibleDeities)), Utility.BundleViewAndModel(new NamePickerModel(this.characterData, TaggedCharacterNameData, TaggedCharacterBynameData, TaggedCharacterEpithetsData)), Utility.BundleViewAndModel(new CharacterSheetModel(this.characterData)));
        this.characterPanels = panels;
    }
    async Randomize(race) {
    ...
    async _waitInitialization(panel) {

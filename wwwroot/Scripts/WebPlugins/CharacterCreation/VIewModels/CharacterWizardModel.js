...
export class CharacterWizardModel extends Wizard {
    constructor() {
        ...
        panels.push(Utility.BundleViewAndModel(new EntryConfigurationModel(globalCharacterData, this.next.bind(this))), Utility.BundleViewAndModel(new PropensityViewModel(globalCharacterData)), Utility.BundleViewAndModel(new BackgroundViewModel(globalCharacterData)), Utility.BundleViewAndModel(new ItemModel(globalCharacterData)));
    }
}

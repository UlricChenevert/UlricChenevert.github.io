export const Races = ["Human", "Orc", "Elf", "Halfling", "Dwarf"];
export const Moralities = ["Good", "Neutral", "Evil"];
export const Order = ["Lawful", "Neutral", "Chaotic"];
export const EconomicClasses = ["Priest", "Noble", "Warrior", "Peasant", "Merchant"];
...
export const EconomicClassDescriptions = [
    {

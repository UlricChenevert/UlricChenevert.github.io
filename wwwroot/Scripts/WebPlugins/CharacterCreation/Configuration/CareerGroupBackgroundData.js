...
export const possibleClasses = ["Skilled & Laborer", "Performer & Scholarly", "Religious", "Martial", "Arcane", "Rogue"];
// const generateScholarBackground = (jobName : JobTypes, PictureUrl? : string) : TaggedCharacterData<StoryModel> => (
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job: jobName as JobType}},
//         Payload: {
//             Name: jobName,
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:JobTypes.Jeweler}},
//         Payload: {
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job: JobTypes.Arbalist}},
//         Payload: {
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job: JobTypes.Scrivener}},
//         Payload: {
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job: JobTypes.Advocate}},
//         Payload: {
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job: JobTypes.Cartographer}},
//         Payload: {
...
//     // {
//     //     Tags:{Profession:{Class:"Skilled & Laborer", Job:"Rat Catcher"}},
//     //     Payload: {
//     //         Name: "Rat Catcher",
//     //         Story: "Some legal documents being transcribed had a critical error and you were blamed even though you pointed out that the original documents had the same error. To save face, your master blamed you. You were either discharged or left in the night with your supplies.",
//     //         PeopleNames: [/* Master/Colleagues */],
...
//     // --- Smith Background ---
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:"Smith"}},
//         Payload: {
//             Name: "Smith",
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:"Carpenter"}},
//         Payload: {
//             Name: "Carpenter",
//             Story: "You have always loved working with your hands and making things that you saw in your mind. After a lengthy apprenticeship, you had a major falling out with your master. It may have been due to their jealousy or that of another apprentice. There could also have been a real or imagined violation of trust. Now you are on the streets.",
//             PeopleNames: [],
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:"Money Changer"}},
//         Payload: {
//             Name: "Money Changer",
...
//     // --- Ambler Background ---
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:"Ambler"}},
//         Payload: {
//             Name: "Ambler",
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:"Chef"}},
//         Payload: {
//             Name: "Chef",
//             Story: "You worked on the manor of a local lord training and breaking horses. You were discharged due to jealousy of other laborers or because the lord believed that you injured their prize stallion.",
//             PeopleNames: [],
...
//     {
//         Tags:{Profession:{Class:"Skilled & Laborer", Job:"Escaped Thrall"}},
//         Payload: {
//             Name: "Escaped Thrall",
...
//             PartialPictureUrl: "Human\\PD 300dpi 3inW MEN Religious CULTIST Howard Pyle modified.jpg"
//         }
//     },

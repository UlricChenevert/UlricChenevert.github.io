...
export const Ages = ['Child', 'Adult', 'Elder'];
export const ChildhoodBackgroundNames = [
    "Farm Boy",
    "Warlord's Heir",
    "Temple Ward",
    "Tunnel-Born",
...
export const AdultBackgroundNames = [
    "Map Hunter",
    "Betrayed Captain",
    "Court Intriguer",
    "Deep Survivor",
...
export const ElderBackgroundNames = [
    "Veteran Commander",
    "Elder Shaman",
    "Ancient Trader",
    "Clan Elder",
...
export const ChildhoodBackgrounds = [
    {
        Tags: {

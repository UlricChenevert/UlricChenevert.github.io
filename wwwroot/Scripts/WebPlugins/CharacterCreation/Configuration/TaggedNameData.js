import { dwarfTag, elfTag, halfingTag, humanTag, ixianTag, orcTag, cultistWholeTag, barbarianWholeTag, warlockWholeTag, acolyteTag, acrobatTag, adeptTag, alchemyTag, armigerTag, charlatanTag, contortionistTag, dowserTag, fenceTag, inquisitorTag, jesterTag, mercenaryTag, minstrelTag, pariahTag, prizefighterTag, researcherTag, ruffianTag, scholarTagRef, spyTag, storytellerTag, touchedTag, urchinTag, wardenTag } from "../Utility/TagUtility.js";
import { ReligionData } from "./DietiesData.js";
export const createMultiTaggedData = (tag, payloads) => {
    return payloads.map(payload => ({
        Tags: [tag],
        Payload: payload
    }));
};
export const TaggedCharacterNameData = [
    // DWARF NAMES
...
// // -----------------------------------------------------------------------------
export const TaggedCharacterBynameData = [
    // DWARF BYNAMES
...
// -----------------------------------------------------------------------------
export const TaggedCharacterEpithetsData = [
    // DWARF EPITHETS

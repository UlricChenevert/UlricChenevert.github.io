...
// Mode
export function buildMode(DependencyInjectionInstance) {
    DependencyInjectionInstance.register(ModeHandler, [KeyEventCommand, LifeCycleEventCommand, GameSceneCommands,

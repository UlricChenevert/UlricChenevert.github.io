...
export namespace ReligionData {
    ...
    export const Enoch = new Deity(
        ...
        "Enoch represents law, order, light, oathkeepers, learning, and writing...",
    ...
    export const Gestas = new Deity(
        ...
        "Gestas represents luck, games of chance, and trickery...", 
    ...
    export const Ghoelb = new Deity(
        ...
        "Ghoelb is a primeval entity that is the embodiment of disorder, malevolent chaos and the void...", 
    ...
    export const Hiram = new Deity(
        ...
        "Hiram represents freedom, wandering, exploring, journeys, fellowship, and drinking...", 
    ...
    export const Moloch = new Deity(
        ...
        "Moloch represents darkness, revenge, death, and grief...", 
    ...
    export const Tubal = new Deity(
        ...
        "Tubal represents fire, metalworking, and crafts in general...", 
    ...
    export const Weut = new Deity(
        ...
        "Weut represents creativity, nature, and creation...",
    ...
    export const Abala = new Deity(
        ...
        "Abala represents agricultural bounty, harvest, and sustenance...",
    ...
    export const Asherah = new Deity(
        ...
        "Asherah represents fertility, forests, and wild growth...",
    ...
    export const Kain = new Deity(
        ...
        "Kain represents fratricide, murder, and the consequences of violence...",

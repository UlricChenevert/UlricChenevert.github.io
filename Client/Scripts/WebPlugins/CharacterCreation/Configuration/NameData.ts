import { DescriptionModel, NameGeneratorTag, NameType, PartOfSpeechModel, SyllableModel, SyllableTag, TaggedData } from "../Contracts/TaggedData";
...
export const taggedAdjectives: TaggedData<PartOfSpeechModel, NameGeneratorTag>[] = [
    ...
    { Tags: { SymbolType: "Adjective", Race: "Orc" }, Payload: { PartOfSpeech: "war-torn" } },
    { Tags: { SymbolType: "Adjective", Race: "Orc" }, Payload: { PartOfSpeech: "blood-frenzied" } },
    { Tags: { SymbolType: "Adjective", Race: "Orc" }, Payload: { PartOfSpeech: "iron-fanged" } },
    ...
    // --- Elf Adjectives (6) ---
    { Tags: { SymbolType: "Adjective", Race: "Elf" }, Payload: { PartOfSpeech: "silver-leafed" } },
    ...
    { Tags: { SymbolType: "Adjective", Race: "Elf" }, Payload: { PartOfSpeech: "star-touched" } },
    ...
    // --- Dwarf Adjectives (6) ---
    { Tags: { SymbolType: "Adjective", Race: "Dwarf" }, Payload: { PartOfSpeech: "deep-stone" } },
    { Tags: { SymbolType: "Adjective", Race: "Dwarf" }, Payload: { PartOfSpeech: "iron-forged" } },
    { Tags: { SymbolType: "Adjective", Race: "Dwarf" }, Payload: { PartOfSpeech: "stout" } },
    { Tags: { SymbolType: "Adjective", Race: "Dwarf" }, Payload: { PartOfSpeech: "mountain-born" } },
    { Tags: { SymbolType: "Adjective", Race: "Dwarf" }, Payload: { PartOfSpeech: "deep-delved" } },
    { Tags: { SymbolType: "Adjective", Race: "Dwarf" }, Payload: { PartOfSpeech: "stone-carved" } },

    // --- Halfling Adjectives (5) ---
    { Tags: { SymbolType: "Adjective", Race: "Halfling" }, Payload: { PartOfSpeech: "humble" } },
    { Tags: { SymbolType: "Adjective", Race: "Halfling" }, Payload: { PartOfSpeech: "warm-hearth" } },
    { Tags: { SymbolType: "Adjective", Race: "Halfling" }, Payload: { PartOfSpeech: "green-tilled" } },
    { Tags: { SymbolType: "Adjective", Race: "Halfling" }, Payload: { PartOfSpeech: "root-bound" } },
    ...
    { Tags: { SymbolType: "Adjective", God: "Tubal" }, Payload: { PartOfSpeech: "tubal-cainite" } },

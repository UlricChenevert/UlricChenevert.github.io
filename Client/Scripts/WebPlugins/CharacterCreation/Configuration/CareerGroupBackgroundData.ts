...
export const possibleJobs : JobType[] = [
...
export const possibleClasses : ProfessionType[] = ["Adventurer" , "Bard" , "Cleric" , "Fighter" , "Magic User" , "Thief"]



const generateScholarBackground = (jobName : JobTypes) : TaggedCharacterData<StoryModel> => (
    {
        Tags:{Profession:{Class:"Adventurer", Job: jobName as JobType}},
        Payload: {
            Name: jobName,
...
export const ClassBackgrounds : TaggedCharacterData<StoryModel>[] = [
    ...
    generateScholarBackground(JobTypes.Inspector),
    ...
    //         PeopleNames: [/* Master/Colleagues */],
    //         PeopleRelations:["Hostile"],
    //         Edges: [new Edges("Sneaky", "You gain an Edge in stealth-related tests.")], // Assuming an 'Edges' constructor
    ...
    //         Edges: TaggedEdgesData.filter((TaggedData)=>filterOnProfession(TaggedData, "Escaped Thrall")).map(x=>x.Payload),

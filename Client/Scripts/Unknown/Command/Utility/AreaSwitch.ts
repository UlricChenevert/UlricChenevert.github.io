...
import { TranslateCoordinate, Translation } from "./CoordinateManipulation.js"

export interface RectangleArea {topLeft : Coordinate, bottomRight : Coordinate}
export interface SquareArea {topLeft : Coordinate, length : number}

export const TranslateSquareArea = (oldSquareArea : SquareArea, translation : {x : Translation, y : Translation}) => {
    return {
...
export const AreaSwitch = (
    testPosition : Coordinate, testArea : SquareArea, 
    outsideAreaTopLeft    : Function, outsideAreaTopCenter    : Function, outsideAreaTopRight    : Function,
    outsideAreaCenterLeft : Function, insideArea              : Function, outsideAreaCenterRight : Function,
    outsideAreaBottomLeft : Function, outsideAreaBottomCenter : Function, outsideAreaBottomRight : Function
) => {
